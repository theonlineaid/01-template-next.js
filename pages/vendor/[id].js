                                    ...
                                    <>
                                        <div className="sidebar-widget widget-store-info mb-30 bg-3 border-0">
                                            <div className="vendor-logo mb-30">
                                                <img src={`/assets/imgs/vendor/${singleStore.img}`} alt="aid" />
                                            </div>
                                            <div className="vendor-info">
                                                ...
                                                <div className="ollow-social mb-20">
                                                    ...
                                                    <ul className="social-network">
                                                        <li className="hover-up">
                                                            <a href="#">
                                                                <img src="/assets/imgs/theme/icons/social-tw.svg" alt="aid" />
                                                            </a>
                                                        </li>
                                                        <li className="hover-up">
                                                            <a href="#">
                                                                <img src="/assets/imgs/theme/icons/social-fb.svg" alt="aid" />
                                                            </a>
                                                        </li>
                                                        <li className="hover-up">
                                                            <a href="#">
                                                                <img src="/assets/imgs/theme/icons/social-insta.svg" alt="aid" />
                                                            </a>
                                                        </li>
                                                        <li className="hover-up">
                                                            <a href="#">
                                                                <img src="/assets/imgs/theme/icons/social-pin.svg" alt="aid" />
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                ...
                                                <div className="vendor-info">
                                                    <ul className="ont-sm mb-20">
                                                        <li>
                                                            <img className="mr-5" src="assets/imgs/theme/icons/icon-location.svg" alt="aid" />
                                                            <strong>Address: </strong> <span>5171 W Campbell Ave undefined, Utah 53127 United States</span>
                                                        </li>
                                                        <li>
                                                            <img className="mr-5" src="assets/imgs/theme/icons/icon-contact.svg" alt="aid" />
