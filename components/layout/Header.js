                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <ul className="language-dropdown">
                                                <li>
                                                    <Link href="/#">
                                                        <img src="/assets/imgs/theme/flag-fr.png" alt="aid" />
                                                        Français
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link href="/#">
                                                        <img src="/assets/imgs/theme/flag-dt.png" alt="aid" />
                                                        Deutsch
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link href="/#">
                                                        <img src="/assets/imgs/theme/flag-ru.png" alt="aid" />
                                                        Pусский
                                                    </Link>
                                                </li>
                                            </ul>
                                    ...
                                    <div className="header-action-2">
                                        ...
                                        <div className="header-action-icon-2">
                                            <Link href="/page-account">
                                                <img className="svgInject" alt="aid" src="/assets/imgs/theme/icons/icon-user.svg" />
                                            </Link>
                                            <Link href="/page-account">
                                                ...
                                                <ul className="mega-menu">
                                                    ...
                                                    <li className="sub-mega-menu sub-mega-menu-width-34">
                                                        <div className="menu-banner-wrap">
                                                            <a href="#">
                                                                <img src="/assets/imgs/banner/banner-menu.png" alt="aid" />
                                                            </a>
