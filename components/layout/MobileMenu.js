                ...
                <div className="mobile-header-wrapper-inner">
                    ...
                    <div className="mobile-header-content-area">
                        ...
                        <div className="mobile-social-icon">
                            ...
                            <Link href="#">
                                <img src="/assets/imgs/theme/icons/icon-facebook.svg" alt="aid" />
                            </Link>
                            <Link href="#">
                                <img src="/assets/imgs/theme/icons/icon-twitter.svg" alt="aid" />
                            </Link>
                            <Link href="#">
                                <img src="/assets/imgs/theme/icons/icon-instagram.svg" alt="aid" />
                            </Link>
                            <Link href="#">
                                <img src="/assets/imgs/theme/icons/icon-pinterest.svg" alt="aid" />
                            </Link>
                            <Link href="#">
                                <img src="/assets/imgs/theme/icons/icon-youtube.svg" alt="aid" />
                            </Link>
                        </div>
                    </div>
                </div>
