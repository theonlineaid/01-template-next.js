        ...
        <>
            <div className="widget-area">
                ...
                <div className="sidebar-widget widget-category-2 mb-50">
                    ...
                    <ul>
                        <li>
                            <Link href="/products"> <img src="/assets/imgs/theme/icons/category-1.svg" alt="aid" />Milks & Dairies</Link><span className="count">30</span>
                        </li>
                        <li>
                            <Link href="/products"> <img src="/assets/imgs/theme/icons/category-2.svg" alt="aid" />Clothing</Link><span className="count">35</span>
                        </li>
                        <li>
                            <Link href="/products"> <img src="/assets/imgs/theme/icons/category-3.svg" alt="aid" />Pet Foods</Link><span className="count">42</span>
                        </li>
                        <li>
                            <Link href="/products"> <img src="/assets/imgs/theme/icons/category-4.svg" alt="aid" />Baking material</Link><span className="count">68</span>
                        </li>
                        <li>
                            <Link href="/products"> <img src="/assets/imgs/theme/icons/category-5.svg" alt="aid" />Fresh Fruit</Link><span className="count">87</span>
                        </li>
                    </ul>
                </div>
                ...
                <div className="sidebar-widget widget_instagram mb-50">
                    ...
                    <div className="instagram-gellay">
                        <ul className="insta-feed">
                            <li>
                                <Link href="#"><img className="border-radius-5" src="/assets/imgs/shop/thumbnail-1.jpg" alt="aid" /></Link>
                            </li>
                            <li>
                                <Link href="#"><img className="border-radius-5" src="/assets/imgs/shop/thumbnail-2.jpg" alt="aid" /></Link>
                            </li>
                            <li>
                                <Link href="#"><img className="border-radius-5" src="/assets/imgs/shop/thumbnail-3.jpg" alt="aid" /></Link>
                            </li>
                            <li>
                                <Link href="#"><img className="border-radius-5" src="/assets/imgs/shop/thumbnail-4.jpg" alt="aid" /></Link>
                            </li>
                            <li>
                                <Link href="#"><img className="border-radius-5" src="/assets/imgs/shop/thumbnail-5.jpg" alt="aid" /></Link>
                            </li>
                            <li>
                                <Link href="#"><img className="border-radius-5" src="/assets/imgs/shop/thumbnail-6.jpg" alt="aid" /></Link>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="banner-img wow fadeIn mb-50 animated d-lg-block d-none">
                    <img src="/assets/imgs/banner/banner-11.png" alt="aid" />
